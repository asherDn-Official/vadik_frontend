...
const BASE_TEMPLATES = [
  ...
  },
  {
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Sent after a customer successfully chooses START.",
  },
  {
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Used in double start confirmation flows.",
  },
  {
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Sent when a customer first requests to STOP updates, to confirm their decision.",
  },
  {
  ...
  },
  {
    ...
    vars: ["Name", "Store Name"],
    usedIn: "First reminder for customers to choose START.",
  },
  {
    id: "start_reminder_2",
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Second reminder for customers to choose START.",
  },
  {
    id: "start_reminder_3",
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Third reminder for customers to choose START.",
  },
  {
    ...
    vars: ["Name", "Store Name"],
    usedIn: "Final reminder in the start consent sequence.",
  },
  {
