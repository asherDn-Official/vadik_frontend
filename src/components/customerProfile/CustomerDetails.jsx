    ...
    <div className="bg-white rounded-lg p-6 w-full max-w-sm shadow-lg">
      ...
      <div className="mt-4 flex justify-end space-x-2">
        ...
        <button
          onClick={() => {
            // Call WhatsApp API
            fetch("https://graph.facebook.com/v22.0/623962650808290/messages", {
              method: "POST",
              headers: {
                Authorization: "Bearer EAAYZCFfB7XeMBO11ZAZAYfXXlB5xKZCqpCZC5ppz5DDNWQtn12bUKG2VUXaWSvyJK3fZClJFyfyT0ZCltM4GSstL2ydJUKV1ItM2ANeGSNnfAkqQrp9ulKgzY5pFKm4Iiq9JjoY2QLJgtWw8q9E0XnUIVEzaZBpmyWrBOYGSOAeiNxoZCXa4Oe5VquwyNcOUAwsqnRpzzGUtt9NYwL8LxJ48NC1HILDqajqRuRLuz",
