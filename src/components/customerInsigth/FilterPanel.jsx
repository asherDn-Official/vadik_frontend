...
// Extracted as a proper React component so that useState is called
// at the top level of a component (fixes React error #310).
const SelectFilterInput = ({ filterKey, filters, onFilterChange, filterConfig }) => {
