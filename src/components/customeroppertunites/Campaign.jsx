...
function Campaign({ onUpdatePlan, onClose }) {
  ...
  return (
    <div className=" top-6 right-6 bg-white rounded-xl border border-[#E8E8E8] shadow-[0_4px_20px_rgba(0,0,0,0.05)] p-4 w-[250px]">
      ...
      <div className="flex justify-between items-start mb-2">
        <div className="leading-tight pb-1">
          <p className="text-[16px] leading-none tracking-normal font-normal text-gray-500">
            Activity Credits :<span className="text-[#EC396F]"> {currentCount}</span>
